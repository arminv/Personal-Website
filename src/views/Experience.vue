        ...
        <div class="timeline">
          ...
          >
            <vue-timeline-update
              ...
              description="<li>Implemented new features (using Lit, TypeScript, and Redux) while working closely with Product Owners and Designers</li>
